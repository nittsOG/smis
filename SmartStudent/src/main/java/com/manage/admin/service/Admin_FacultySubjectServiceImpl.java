...
public class Admin_FacultySubjectServiceImpl implements Admin_FacultySubjectService {
	...
	@Autowired
	public Admin_FacultySubjectServiceImpl(
			@Qualifier("adminFacultySubjectDAOImpl") Admin_FacultySubjectDAO adminFacultySubjectDAO) {
	...
	public List<FacultySubject> getFacultySubjectsByFacultyId(Long facultyId) {
		return adminFacultySubjectDAO.getFacultySubjectsByFacultyId(facultyId);
	}
}
