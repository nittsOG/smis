...
@Repository
@Qualifier("adminSemesterResultsDAOImpl")
@Transactional("adminTransactionManager")
public class Admin_SemesterResultsDAOImpl implements Admin_SemesterResultsDAO {

    private final SessionFactory sessionFactory;

    @Autowired
    public Admin_SemesterResultsDAOImpl(@Qualifier("adminSessionFactory") SessionFactory sessionFactory) {
