...
@Repository
@Qualifier("managerAttendanceDAOImpl")
...
public class Manager_AttendanceDAOImpl implements Manager_AttendanceDAO {
	...
	public List<Attendance> getFilteredAttendances(Long studentId, Long divisionId, Long subjectId, Date date) {
		...
		Query<Attendance> query = sessionFactory.getCurrentSession().createQuery(queryBuilder.toString(),
				Attendance.class);
	...
	public void deleteAttendance(Attendance attendance) {
		this.deleteAttendance(attendance.getAttendanceId());
	}
}
