...
<body>
    <div class="container">
        <h2><i class="fas fa-plus-circle"></i> Add New Faculty Division</h2>
        <form action="${pageContext.request.contextPath}/admin/facultyDivisions/new" method="post">
            ...
            <div class="row">
                ...
                <div class="value">
                    <input type="text" id="faculty" name="faculty.facultyId" required />
                </div>
            </div>
            ...
            <div class="status">
                ...
                <a class="link" href="${pageContext.request.contextPath}/admin/facultyDivisions"><i
