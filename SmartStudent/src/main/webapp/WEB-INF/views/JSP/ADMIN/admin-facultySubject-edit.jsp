<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
    <%@ taglib uri="http://www.springframework.org/tags/form" prefix="form" %>
        ...
        <body>
            <div class="container">
                <h2><i class="fas fa-edit"></i> Edit Faculty Subject</h2>
                ...
                <form
                    ...
                    <div class="row">
                        ...
                        <div class="value">
                            <input type="text" name="facultyId" value="${facultySubject.faculty.facultyId}"
                                disabled="true" />
                        </div>
                    </div>
                            ...
                            <select name="subjectId" required>
                                <c:forEach var="subject" items="${subjects}">
                                    <option value="${subject.subjectId}"
                                        ${subject.subjectId==facultySubject.subject.subjectId ? 'selected' : '' }>
                                        ${subject.name}
                                    </option>
                                </c:forEach>
                            </select>
                    ...
                    <div class="status">
                        ...
                        <a class="link" href="${pageContext.request.contextPath}/admin/facultySubjects">
