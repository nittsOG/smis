...
<body>
    <div class="navbar">
        <h2><i class="fas fa-chalkboard-teacher"></i> Faculty Divisions List</h2> <!-- Added icon -->
    ...
    <div class="container">
                    ...
                    <c:forEach var="facultyDivision" items="${facultyDivisions}">
                        <tr>
                            ...
                            <td class="action-links">
                                <a href="${pageContext.request.contextPath}/admin/facultyDivisions/${facultyDivision.facultyDivisionId}"
                                    class="view-btn">
                                    <i class="fas fa-eye"></i> View</a>
                                <a href="${pageContext.request.contextPath}/admin/facultyDivisions/${facultyDivision.facultyDivisionId}/edit"
                                    class="edit-btn">
                                    <i class="fas fa-edit"></i>Edit</a>
                                <a href="${pageContext.request.contextPath}/admin/facultyDivisions/${facultyDivision.facultyDivisionId}/delete"
                                    class="delete-btn" onclick="return confirm('Are you sure, you want to delete?');">
        ...
        <a href="${pageContext.request.contextPath}/admin/facultyDivisions/new" class="add-link">
