...
<body>
  <div class="navbar">
    <h2><i class="fas fa-tasks"></i>Backlogs</h2>
  ...
  <div class="container">
    ...
    <form action="${pageContext.request.contextPath}/admin/backlogs" method="get">
      ...
      <input type="text" id="studentId" name="studentId" value="${studentId}" placeholder="Enter Student ID" />
      <button type="submit" class="filter-btn">Filter</button>
      <a href="${pageContext.request.contextPath}/admin/backlogs" class="filter-btn">Clear Filter</a>
    </form>
          ...
          <c:forEach var="backlog" items="${backlogs}">
            <tr>
              ...
              <td class="action-links">
                <a href="${pageContext.request.contextPath}/admin/backlogs/${backlog.studentId}/${backlog.subjectCode}/${backlog.semester}"
                  class="view-btn">
                  <i class="fas fa-eye"></i> View
                </a>
                <a href="${pageContext.request.contextPath}/admin/backlogs/${backlog.studentId}/${backlog.subjectCode}/${backlog.semester}/edit"
                  class="edit-btn">
                  <i class="fas fa-edit"></i> Edit
                </a>
                <a href="${pageContext.request.contextPath}/admin/backlogs/${backlog.studentId}/${backlog.subjectCode}/${backlog.semester}/delete"
    ...
    <!-- Add New Backlog -->
    <a href="${pageContext.request.contextPath}/admin/backlogs/new" class="add-link"><i class="fas fa-plus-circle"></i>
      Add New
      Backlog
    </a>
