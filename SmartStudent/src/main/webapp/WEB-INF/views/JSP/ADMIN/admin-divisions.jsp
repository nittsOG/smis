...
<body>
    <div class="navbar">
        <h2><i class="fas fa-list-alt"></i>Divisions List</h2>
    ...
    <div class="container">
        ...
        <!-- Filter Form -->
        <form action="${pageContext.request.contextPath}/admin/divisions" method="get">
            <label for="departmentFilter">Filter by Department:</label>
            <select id="departmentFilter" name="department">
                <option value="">-- Select Department --</option>
                <c:forEach var="departmentOption" items="${departments}">
                    <option value="${departmentOption.departmentId}" <c:if
                        test="${param.department == departmentOption.departmentId}">selected</c:if>
                    ...
                    <c:forEach var="division" items="${divisions}">
                        <tr>
                            ...
                            <td class="action-links">
                                <a href="${pageContext.request.contextPath}/admin/divisions/${division.divisionId}"
                                    class="view-btn"><i class="fas fa-eye"></i> View</a>
                                <a href="${pageContext.request.contextPath}/admin/divisions/${division.divisionId}/edit"
                                ...
                                <a href="${pageContext.request.contextPath}/admin/divisions/${division.divisionId}/delete"
                                    class="delete-btn" onclick="return confirm('Are you sure, you want to delete?');"><i
        ...
        <a href="${pageContext.request.contextPath}/admin/divisions/new" class="add-link">
            <i class="fas fa-plus-circle"></i> Add New Division
        </a>
