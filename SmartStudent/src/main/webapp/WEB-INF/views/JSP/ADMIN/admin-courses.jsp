<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    ...
    <body>
        <div class="navbar">
            <h2><i class="fas fa-book"></i>Courses List</h2>
        ...
        <div class="container">
                ...
                <select id="departmentFilter" name="departmentId">
                    ...
                    <c:forEach var="department" items="${departments}">
                        <option value="${department.departmentId}" <c:if
                            test="${param.departmentId == department.departmentId}">selected</c:if>>${department.name}
                        </option>
                    </c:forEach>
                </select>
                        ...
                        <c:forEach var="course" items="${courses}">
                            <tr>
                                ...
                                <td class="action-links">
                                    <a href="${pageContext.request.contextPath}/admin/courses/${course.courseId}"
                                        class="view-btn">
                                        <i class="fas fa-eye"></i> View
                                    </a>
                                    <a href="${pageContext.request.contextPath}/admin/courses/${course.courseId}/edit"
                                        class="edit-btn">
                                        <i class="fas fa-edit"></i> Edit
                                    </a>
                                    <a href="${pageContext.request.contextPath}/admin/courses/${course.courseId}/delete"
            ...
            <a href="${pageContext.request.contextPath}/admin/courses/new" class="add-link"><i
