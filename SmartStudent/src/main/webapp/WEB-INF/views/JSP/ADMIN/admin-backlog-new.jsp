<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
    ...
    <body>
        <div class="container">
            <h2><i class="fas fa-plus-circle"></i> Add New Backlog</h2>
            <form action="${pageContext.request.contextPath}/admin/backlogs/new" method="post">
                ...
                <div class="row">
                    <div class="label">
                        <i class="fas fa-book-open"></i> Subject Code:
                    </div>
                    <div class="value">
                ...
                <div class="row">
                    <div class="label">
                        <i class="fas fa-check-circle"></i> Backlog Status:
                    </div>
                    <div class="value">
                        <input type="text" id="backlogStatus" name="backlogStatus" required />
                    </div>
                </div>

                <div class="status">
                    <button type="submit"><i class="fas fa-save"></i> Save</button>
                    <a class="link" href="${pageContext.request.contextPath}/admin/backlogs"><i
