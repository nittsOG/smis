    ...
    <div class="container">
        ...
        <form action="<c:url value='/admin/departments/${department.departmentId}/edit'/>" method="post">
            ...
            <div class="row">
                ...
                <div class="value">${department.name}
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="value">${department.description}
                </div>
            </div>

            <div class="row">
                <div class="label">
                    <i class="fas fa-briefcase"></i> Field:
                </div>
                <div class="value">${department.field}
                </div>
            </div>

            <div>
                <button type="submit"><i class="fas fa-save"></i> Save</button>
                <a class="back-link" href="<c:url value='/admin/departments'/>">
