...
<body>
    ...
    <div class="container">
        ...
        <form action="<c:url value='/admin/departments'/>" method="get">
            ...
            <select id="departmentFilter" name="search">
                ...
                <c:forEach var="departmentOption" items="${departments}">
                    <option value="${departmentOption.name}" <c:if test="${param.search == departmentOption.name}">
                        selected</c:if>>${departmentOption.name}</option>
                </c:forEach>
            </select>
            ...
            <select id="fieldFilter" name="field">
                ...
                <c:forEach var="fieldOption" items="${fields}">
                    <option value="${fieldOption}" <c:if test="${param.field == fieldOption}">selected</c:if>
                        >${fieldOption}</option>
                </c:forEach>
            </select>
                    ...
                    <c:forEach var="department" items="${departments}">
                        <tr>
                            ...
                            <td class="action-links">
                                <a href="<c:url value='/admin/departments/${department.departmentId}'/>"
                                    class="view-btn">
                                    <i class="fas fa-eye"></i> View
                                </a>
                                <a href="<c:url value='/admin/departments/${department.departmentId}/edit'/>"
                                    class="edit-btn">
                                    <i class="fas fa-edit"></i> Edit
                                </a>
                                <a href="<c:url value='/admin/departments/${department.departmentId}/delete'/>"
        ...
        <a href="<c:url value='/admin/departments/new'/>" class="add-link">
