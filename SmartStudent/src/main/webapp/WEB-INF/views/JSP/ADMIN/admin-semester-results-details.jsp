...
<body>
    ...
    <hr>
    <a href="${pageContext.request.contextPath}/admin/semester-results/${semesterResults.studentId}/${semesterResults.semester}/${semesterResults.subjectCode}/edit">Edit</a>
    <a href="${pageContext.request.contextPath}/admin/semester-results/${semesterResults.studentId}/${semesterResults.semester}/${semesterResults.subjectCode}/delete">Delete</a>
