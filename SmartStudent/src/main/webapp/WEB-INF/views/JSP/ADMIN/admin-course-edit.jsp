    ...
    <div class="container">
        ...
        <form action="${pageContext.request.contextPath}/admin/courses/${course.courseId}/edit" method="post">
            <div class="row">
                ...
                <div class="value">${course.courseId}</div>
            </div>
            ...
            <div class="row">
                ...
                <div class="value">${course.specialization}
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="value">${course.description}
                </div>
            </div>
                    ...
                    <select id="department" name="department.departmentId" required>
                        ...
                        <c:forEach var="department" items="${departments}">
                            <option value="${department.departmentId}" <c:if
                                test="${course.department != null && course.department.departmentId == department.departmentId}">
                                selected
                                </c:if>>
                                ${department.name}
                            </option>
            ...
            <div>
                ...
                <a class="back-link" href="${pageContext.request.contextPath}/admin/courses">
