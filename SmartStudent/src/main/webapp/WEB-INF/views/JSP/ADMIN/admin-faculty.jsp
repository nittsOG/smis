<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
    ...
    <body>
        <div class="navbar">
            <h2><i class="fas fa-chalkboard-teacher"></i> Faculty Members</h2> <!-- Added icon -->
        ...
        <div class="container">
            <form method="GET" action="${pageContext.request.contextPath}/admin/faculty">
                ...
                <input type="text" id="facultyId" name="facultyId" value="${param.facultyId}" class="large-input" />
                <label for="department">Filter by Department:</label>
                <select id="department" name="department">
                    <option value="">--All--</option>
                    <c:forEach var="department" items="${departments}">
                        <option value="${department.name}" <c:if test="${department.name == param.department}">selected
                        ...
                        <c:forEach var="faculty" items="${faculty}">
							...
							<form
								...
								<button type="submit"
                                    ...
                                    <a href="${pageContext.request.contextPath}/admin/faculty/${faculty.facultyId}"
                                        class="view-btn">
                                        <i class="fas fa-eye"></i> View
                                    </a>
                                    <a href="${pageContext.request.contextPath}/admin/faculty/${faculty.facultyId}/edit"
                                        class="edit-btn">
                                        <i class="fas fa-edit"></i> Edit
                                    </a>
                                    <a href="${pageContext.request.contextPath}/admin/faculty/${faculty.facultyId}/delete"
                                        class="delete-btn"
            ...
            <a href="${pageContext.request.contextPath}/admin/faculty/add" class="add-link">
