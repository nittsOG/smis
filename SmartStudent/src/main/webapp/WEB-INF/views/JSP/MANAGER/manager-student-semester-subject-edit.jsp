...
<body>
	...
	<form method="post"
		action="${pageContext.request.contextPath}/manager/student-semester-subjects/${studentSemesterSubject.studentSemesterSubjectId}/edit">
	...
	<a
		href="${pageContext.request.contextPath}/manager/student-semester-subjects">Back
		to list</a>
</body>
</html>
