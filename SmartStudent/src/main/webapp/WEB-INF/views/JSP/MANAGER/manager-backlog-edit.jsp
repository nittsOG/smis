...
<body>
    ...
    <form action="${pageContext.request.contextPath}/manager/backlogs/${backlog.studentId}/${backlog.subjectCode}/${backlog.semester}/edit" method="post">
        ...
        <a href="${pageContext.request.contextPath}/manager/backlogs">Cancel</a>
    </form>
</body>
</html>
