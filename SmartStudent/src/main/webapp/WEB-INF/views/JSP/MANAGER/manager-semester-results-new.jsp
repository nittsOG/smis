...
<body>
    ...
    <hr>
    <form action="${pageContext.request.contextPath}/manager/semester-results/new" method="post">
        <table border="1">
            <tr>
                <th>Student ID</th>
    ...
    <a href="${pageContext.request.contextPath}/manager/semester-results">Back to Semester Results List</a>
</body>
</html>
