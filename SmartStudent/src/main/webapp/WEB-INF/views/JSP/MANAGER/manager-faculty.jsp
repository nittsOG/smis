...
<body>
	...
	<form method="GET"
		action="${pageContext.request.contextPath}/manager/faculty">
				...
				<c:forEach var="faculty" items="${faculty}">
					<tr>
						...
						<td class="action-buttons">
							<!-- View Button -->
							<form
								action="${pageContext.request.contextPath}/manager/faculty/${faculty.facultyId}"
								method="GET" style="display: inline;">
								<button type="submit">View</button>
							</form> <!-- Edit Button -->
							<form
								action="${pageContext.request.contextPath}/manager/faculty/${faculty.facultyId}/edit"
								method="GET" style="display: inline;">
								<button type="submit">Edit</button>
							</form> <!-- Delete Button -->
<%-- 							<form
								action="${pageContext.request.contextPath}/manager/faculty/delete/${faculty.facultyId}"
		...
		<p>
			<a href="${pageContext.request.contextPath}/manager/faculty/add">
				Add New Faculty</a>
		</p>
	</div>
</body>
