...
<body>
	...
	<a href="${pageContext.request.contextPath}/manager/facultyDivisions">Back
		to List</a> |
	<a
		href="${pageContext.request.contextPath}/manager/facultyDivisions/${facultyDivision.facultyDivisionId}/edit">Edit</a>
