...
<body>
    ...
    <form action="${pageContext.request.contextPath}/manager/timetables" method="get">
        ...
        <tbody>
            <c:forEach var="timetable" items="${timetables}">
                <tr>
                    ...
                    <td>
                        <a href="${pageContext.request.contextPath}/manager/timetables/${timetable.timetableId}">View</a> |
                        <a href="${pageContext.request.contextPath}/manager/timetables/${timetable.timetableId}/edit">Edit</a> |
                        <a href="${pageContext.request.contextPath}/manager/timetables/${timetable.timetableId}/delete" onclick="return confirm('Are you sure?')">Delete</a>
                    </td>
                </tr>
            </c:forEach>
        </tbody>
    ...
    <a href="${pageContext.request.contextPath}/manager/timetables/new">Add New Timetable</a>
</body>
</html>
