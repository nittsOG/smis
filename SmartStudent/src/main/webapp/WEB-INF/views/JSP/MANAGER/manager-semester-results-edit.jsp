...
<body>
    ...
    <hr>
    <form action="${pageContext.request.contextPath}/manager/semester-results/${semesterResults.studentId}/${semesterResults.semester}/${semesterResults.subjectCode}/edit" method="post">
        ...
        <a href="${pageContext.request.contextPath}/manager/semester-results/${semesterResults.studentId}/${semesterResults.semester}/${semesterResults.subjectCode}">Cancel</a>
    </form>
    <hr>
