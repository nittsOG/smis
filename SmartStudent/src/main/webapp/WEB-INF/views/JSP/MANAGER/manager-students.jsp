...
<body>
    ...
    <form method="GET" action="${pageContext.request.contextPath}/manager/students">
                ...
                <c:forEach var="student" items="${students}">
                    <tr>
                        ...
                        <td class="action-buttons">
                            <!-- View Button -->
                            <form action="${pageContext.request.contextPath}/manager/students/${student.studentId}" method="GET" style="display:inline;">
                                <button type="submit">View</button>
                            </form>
                            <!-- Edit Button -->
                            <form action="${pageContext.request.contextPath}/manager/students/${student.studentId}/edit" method="GET" style="display:inline;">
                                <button type="submit">Edit</button>
                            </form>
<%--                             <!-- Delete Button -->
                            <form action="${pageContext.request.contextPath}/manager/students/delete/${student.studentId}" method="post" style="display:inline;">
...
<%--         <p><a href="${pageContext.request.contextPath}/manager/students/add"> Add New Student</a></p> --%>
    </div>
</body>
</html>
